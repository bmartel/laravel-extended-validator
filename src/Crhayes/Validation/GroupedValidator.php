...
class GroupedValidator {
	...
	public function passes() {
		...
		if (!count($this->validators))
			throw new MissingValidatorException('No validators provided: You must provide at least one validator');
	...
	/**
	 * Sets the GroupValidator to use another instance of BatchValidator
	 *
